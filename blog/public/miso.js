		...
		return function(element, isInitialized) {
			if(typeof jQuery !== 'undefined' && typeof jQuery.fn.sequenceDiagram !== 'undefined') {
				if (!isInitialized) {
					...
					//$(element).Sequencediagrams(element);
